...
public class PenteWindow extends JFrame {
	...
	/**
	 * this is the main container for the playing state. Contains a Board and InfoBar.
	 */
	private JPanel container;

	/**
	 * this is the main container for the starting state. Contains start menu stuff.
	 */
	...
	/**
	 * The following 3 JButtons belong on the starting screen.
	 */
	 ...
	 * Constructs this GUI component by calling its init() method.
	 */
	public PenteWindow () {
	...
	public void init () {// Creates the JFrame, and starts the game
		...
		// Formats the 19 x 19 button	
//		btn19Grid = new JButton("19 x 19");
//		btn19Grid.setFont(new Font("Tahoma",Font.PLAIN,20));
//		btn19Grid.setOpaque(false);
//		btn19Grid.setContentAreaFilled(false);
//		btn19Grid.setBorderPainted(false);
//		btn19Grid.setForeground(Color.WHITE);
//		btn19Grid.setSize(new Dimension(60, 40));
//
//		btn19Grid.addMouseListener(new MouseAdapter() {
//			public void mouseClicked ( MouseEvent e ) {
//
//			}
//
...
//			// is hovered over
//			public void mouseEntered(java.awt.event.MouseEvent evt) {
//				btn19Grid.setBackground(Color.DARK_GRAY);
//				btn19Grid.setOpaque(true);
//				btn19Grid.setContentAreaFilled(true);
//			}
//			public void mouseExited(java.awt.event.MouseEvent evt) {
//				btn19Grid.setOpaque(false);
//				btn19Grid.setContentAreaFilled(false);
//				btn19Grid.setBorderPainted(false);
//				btn19Grid.setBackground(Color.black);
//			}
//		});
//		btnPanel.add(btn19Grid);
	 ...
	 * @param is13by13 - specifies whether or not the Board should be 13x13.
	 */
	...
	/**
	 * Returns an ArrayList<JButton> containing all of the JButtons on the start menu.
	 ...
	 * @param blackCaps
	 */
	public void setMessage ( boolean turnstatus, String message,
	                     int whiteCaps, int blackCaps ) {
