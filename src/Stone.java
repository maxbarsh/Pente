...
/**
 * Represents a single game Tile. Must be in 1 of 3 states: black, white, or
 * unoccupied.
 */
public class Stone extends JPanel {
	...
	/**
	 * enumeration representing the Tile status. 0 - unoccupied; 1 - white; 2 - black.
	 */
	private int status;
	 ...
	 * @param status  :  new integer value for this Stone. Must be between 0 & 2 inclusive.
	 */
